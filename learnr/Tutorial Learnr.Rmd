...
Esto se hace con la opción `exercise.startover` en el chunk de código (por defecto es TRUE). El siguiente ejercicio NO se puede reiniciar (es decir `exercise.startover = FALSE`)
