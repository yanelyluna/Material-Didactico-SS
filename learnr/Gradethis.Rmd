...
```{r ejercicio1-check}
gradethis::grade_this_code(correct = "Sabes leer", incorre = "No sabes nada")
```
...
#Haz una muestra de 10 normales con media 3 y varianza 4
...
```{r ejercicio2-check}
gradethis::grade_this_code(correct = "Sabes leer", incorre = "No sabes nada", allow_partial_matching = TRUE)
```
