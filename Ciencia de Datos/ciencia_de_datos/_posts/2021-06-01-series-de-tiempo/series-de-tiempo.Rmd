...
-   [Pronóstico]{.ul}: $\hat{y}_{T+1} = \hat{S}_T$
    ...
    $$
    \hat{y}_{T+2} = \hat{S}_{T+1} = (1-\omega)y_{T+1} + \omega \hat{S}_T = (1-\omega) \hat{S}_T + \omega \hat{S}_T = \hat{S}_T \\
...
-   De hecho, para $T$ grande
    ...
    $$
    \bar{y}_{1, T-1} \approx \bar{y}_{2, T} \approx \bar{y} = \frac{1}{T} \sum_{t =1}^Ty_t\\
