...
for (i in c(1:16)) {
 files[[i]] <- read.csv(paste("https://raw.githubusercontent.com/yanelyluna/Material-Didactico-SS/main/Ciencia%20de%20Datos/tutoriales/purrr/datas/data_from_", 1989 + i, ".csv", sep = ""))
}
