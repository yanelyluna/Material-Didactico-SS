...
Recuerda que si necesitas ayuda con alguna función o comando en específico, siempre puedes usar la función `help()` que te muestra la documentación correspondiente a dicha función o comando, por ejemplo, `help("matrix")`
