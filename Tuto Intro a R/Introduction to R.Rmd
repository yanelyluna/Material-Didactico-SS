...
Del siguiente vector creado extrae lo siguiente: - El primer, segundo y tercer valor del vector - El valor 527 y 89 - Los valores asociados a los nombres "p1" y "p5" - Los valores menores o iguales a la media de los valores del vector
...
También podemos ordenar en más de una columna, en la función debemos darla las especificaciones para que se ordene como queramos. **Ejercicio.** Completa el código para que el *dataframe* ordene de forma ascendente los nombres y descendente la altura.
